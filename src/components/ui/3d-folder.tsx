...
export function AnimatedFolder({ title, projects, className, onFolderClick }: AnimatedFolderProps) {
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle at 50% 70%, rgba(255,255,255,0.15) 0%, transparent 70%)",
        ...
        <div className="relative flex items-center justify-center mb-4" style={{ height: "160px", width: "200px" }}>
          ...
          <div
            className="absolute w-32 h-24 bg-folder-back rounded-lg shadow-md border border-white/5"
            style={{
          ...
          <div
            className="absolute w-12 h-4 bg-folder-tab rounded-t-md border-t border-x border-white/5"
            style={{
          ...
          <div
            className="absolute w-32 h-24 bg-folder-front rounded-lg shadow-lg border border-white/10"
            style={{
        ...
        {/* Folder title */}
        <h3
          className="text-lg font-serif uppercase tracking-widest text-foreground mt-4 transition-all duration-300 group-hover:text-primary"
          style={{
        ...
        {/* Project count */}
        <p
          className="text-xs uppercase tracking-wider text-muted-foreground transition-all duration-300 mt-1"
          style={{
        ...
        {/* Hover hint */}
        <div
          className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-1.5 text-[11px] uppercase tracking-widest text-primary/80 transition-all duration-300"
          style={{
